 ...
 */
public class SeguimientoFragment extends Fragment implements OnMapReadyCallback {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot childSnapshot : dataSnapshot.getChildren()) {
                    ...
                    if (map != null) {
                        ...
                        emailUser.add((String) map.get("emailUser"));
                    }
                }
                if(emailUser.contains(correo)){
                    int index = emailUser.indexOf(correo);
                    lat2 = latSupervisor.get(index);
                    lng2 = lngSupervisor.get(index);
                    lat1 = latUser.get(index);
                    lng1 = lngUser.get(index);
                }
        ...
        usersDatabase.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                if(emailUser.contains(correo)){
                    ...
                    lat1 = latUser.get(index);
                    lng1 = lngUser.get(index);
                    place1.position(new LatLng(lat1,lng1)).title(nameUser.get(index));
                    place2.position(new LatLng(lat2,lng2)).title(nameSupervisor.get(index));
                }
